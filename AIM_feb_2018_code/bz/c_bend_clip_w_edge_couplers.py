...
class BendClipEdgeCouplers(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_instances(self, insts):
            ...
            # make edge coupler
            edge_coupler_gds_lay = EdgeCoupler(name=self.name + 'edge_coupler_sffdfi').Layout()
            ...
            # add the bends
            bend_clip_lay = BendClip( name = self.name + '_BEND_CLIP' ).get_default_view(i3.LayoutView)
